    ...
    public static class Help
    {
        ...
        public static object CreateInstaince(System.Type instanceType, object parent)
        {
            ...
            if (parent != null)
            {
                ...
                if (ctor != null)
                {
                    ...
                    {
                        L.LogErrorFormat("type:{0}", instanceType.FullName);
                        L.LogException(ex);
                        throw ex;
                    }
                    finally
            ...
            {
                L.LogErrorFormat("{0}: not find Constructor!", instanceType.Name);
            }
                    ...
                    foreach (var type in types)
                    {
                        ...
                        if (AllTypesByFullName.TryGetValue(type.FullName, out t))
                        {
                            ...
                            if (t != type)
                            {
                                ...
                                L.LogErrorFormat("error:{0}", type.FullName);
                            }
#endif
                            continue;
                        }
        ...
        public static object Create(System.Type type)
        {
            ...
            else
            {
                ...
                if (constructor == null)
                {
                    L.LogErrorFormat("type:{0} not GetConstructor", type.Name);
                    return null;
                }
