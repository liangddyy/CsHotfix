...
namespace CsHotFix.Editor
{
    public static class Hotfix
    {
        ...
        [UnityEditor.MenuItem("CsHotFix/Hotfix Inject In Editor", false, 3)]
        ...
        public static void HotfixInject(string inject_assembly_path, Func<HashSet<string>> fun)
        {
            ...
            try
            {
                ...
                // CsHotAttribute 
                var hotfixAttributeType = assembly.MainModule.Types.Single(t => t.FullName == "CsHotFix.CsHotAttribute");
        ...
        static string getDelegateName(MethodDefinition method)
        {
            ...
            L.LogErrorFormat("method:{0} not field name!", method.Name);
            return "";
        }
        ...
        static bool injectMethod(AssemblyDefinition assembly, MethodDefinition method)
        {
            ...
            {
                Error("查找委托代理失败，请确定是否点击过\"CsHotfix /一键生成\"! can not find delegate for " + method.DeclaringType + "." + method.ToString() + "! try re-genertate code.");
                return false;
            }
