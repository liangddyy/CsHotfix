...
namespace CsHotFix
{
    ...
    public partial class RefType
    {
        ...
        public void SetField(string name, object value)
        {
            ...
            if (field == null)
            {
                L.LogErrorFormat("type:{0} field:{1} not find!", fullType, name);
                return;
            }
            ...
            {
                L.LogErrorFormat("SetField type:{0} name:{1}", type.Name, name);
                L.LogException(ex);
            }
        }
        ...
        public object GetField(string name)
        {
            ...
            {
                L.LogErrorFormat("GetField type:{0} name:{1}", type.Name, name);
                L.LogException(ex);
                return null;
            }
        }
        ...
        public object TryGetField(string name)
        {
            ...
            {
                L.LogErrorFormat("TryGetField type:{0} name:{1}", type.Name, name);
                L.LogException(ex);
                return null;
            }
        }
        ...
        public void TrySetField(string name, object value)
        {
            ...
            {
                L.LogErrorFormat("TrySetField type:{0} name:{1}", type.Name, name);
                L.LogException(ex);
            }
        }
        ...
        public object InvokeMethodReturn(string name, object[] param)
        {
            ...
            {
                L.LogErrorFormat("InvokeMethodReturn type:{0} name:{1}", type.Name, name);
                L.LogException(ex);
                return null;
            }
        }
        ...
        public object TryInvokeMethodReturn(string name, object[] param)
        {
            ...
            {
                L.LogErrorFormat("TryInvokeMethodReturn type:{0} name:{1}", type.Name, name);
                L.LogException(ex);
                return null;
            }
        }
        ...
        public object GetProperty(string name)
        {
            ...
            {
                L.LogErrorFormat("type:{0} Property:{1} not find!", fullType, name);
                return null;
            }
            ...
            {
                L.LogErrorFormat("GetProperty type:{0} name:{1}", type.Name, name);
                L.LogException(ex);
                return null;
            }
        }
        ...
        public void SetProperty(string name, object value)
        {
            ...
            {
                L.LogErrorFormat("SetProperty type:{0} name:{1}", type.Name, name);
                L.LogException(ex);
            }
        }
        ...
        public object TryGetProperty(string name)
        {
            ...
            {
                L.LogErrorFormat("TryGetProperty type:{0} name:{1}", type.Name, name);
                L.LogException(ex);
                return null;
            }
        }
        ...
        public void TrySetProperty(string name, object value)
        {
            ...
            {
                L.LogErrorFormat("TrySetProperty type:{0} name:{1}", type.Name, name);
                L.LogException(ex);
            }
        }
        ...
        [EditorClass]
        [UnityEditor.MenuItem("CsHotFix/RefType优化")]
        static void RefTypeOpt()
        {
            List<string> files = new List<string>();
            var guids = AssetDatabase.FindAssets("RefType_InvokeMethod");
            ...
            if (files.Count > 1)
                throw new Exception("存在多个 RefType_InvokeMethod.cs");
            if (files.Count <= 0)
                throw new Exception("RefType_InvokeMethod.cs 不存在");

            System.Text.StringBuilder sb = new System.Text.StringBuilder();
            sb.AppendFormatLine("namespace CsHotFix");
            sb.AppendFormatLine("{{");
            ...
            string filename = files[0];  // RefType_InvokeMethod.cs file path.
            if (System.IO.File.Exists(filename))
                System.IO.File.Delete(filename);
            System.IO.File.WriteAllText(filename, sb.ToString());
            UnityEditor.AssetDatabase.ImportAsset(filename);
            Debug.Log("write file success:" + filename);
        }
